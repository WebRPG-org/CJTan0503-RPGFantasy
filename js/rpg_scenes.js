...
Scene_Boot.prototype.start = function() {
    ...
    if ($gameSystem.isUserLoggedIn()) {
        var username = $gameSystem.getCurrentUser();
        console.log("Current user in game:", username);
        // Do something with username in game initialization
    }
};
